	...
	<div class="two-grids">
		<div class="container">
            <div class="wthree_head_section">
				<h3 class="w3l_header">Admin<span>Dashboard</span></h3>
			...
			<div class="col-md-6 w3_two_grid_right">
				<div class="w3_two_grid_right1">
					...
					<div class="col-xs-9 w3_two_grid_right_gridr">
						<h4><a href="manage-users.php">Manage Users</a></h4>
				...
				<div class="w3_two_grid_right1">
					...
					<div class="col-xs-9 row w3_two_grid_right_gridr">
						<h4><li><a href="todaysOrder.php">Today's Orders</a></li>
						    <li><a href="pendingOrder.php">Pending Orders</a></li>
							<li><a href="deliveredOrder.php">Delivered Orders</a></li>
						</h4>
