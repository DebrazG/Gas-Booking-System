...
if(isset($_POST['submit']))
{
	...
	$email=$_POST['email'];
	$text=$_POST['text'];
	$result=mysqli_query($conn,"insert into query(name,email,text) values('$name','$email','$text')");
	while($row = mysqli_fetch_array($result))
	$_SESSION['msg']="Successfully Posted !!";
    header('Refresh:1;url=talk to us.php');	
}
?>
<!DOCTYPE php>
<php lang="en">
...
<!-- main-section -->	
	...
	<div class="wthree_head_section">
				<h3 class="w3l_header">Do you have any questions?</span></h3>
