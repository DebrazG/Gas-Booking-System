		...
		<div class="container">
			<div class="bs-docs-example">
				<table class="table table-bordered">
					...
					<tbody>
<?php $query=mysqli_query($conn,"select connection.name as name,connection.address as address,connection.state as state,connection.district as district,connection.city as city,connection.pin as pin,connection.cno as cno,connection.email as email,orders.orderdate as odate,orders.paymentmethod as paym,orders.id as orderid from orders join connection on orders.userid=connection.userid where orders.userid='".$_SESSION['userid']."' and orders.paymentmethod is not null");
$cnt=1;
...
?>
						<tr>
							...
							<td> <a href="javascript:void(0);" onClick="popUpWindow('http://localhost/Gas-agency/track-order.php?oid=<?php echo htmlentities($row['orderid']);?>');" title="Track order">
					            Track</td>
						</tr>
<?php $cnt=$cnt+1;} ?>
					</tbody>
