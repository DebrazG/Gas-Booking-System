...
<!-- //banner -->
	...
	<div class="wthree_head_section">
				<h3 class="w3l_header">My <span>Profile</span></h3>
			</div>
		<div class="login w3">
			<div class="sap_tabs">
<?php
$id=$_SESSION['userid'];
$query=mysqli_query($conn,"select * from connection where userid='$id'");
								...
								<input type="hidden" name="userid" value="" id="id">
									<div class="w3_agileits_main_grid w3l_main_grid">
										<div class="agileits_grid">
											<div class="name">
												<img src="http://localhost/Gas-Agency/images/photos/<?php echo htmlentities($row['photo']);?>" style="height:200px;padding:5px;border:1px solid;">
											</div>
											<div class="clear"></div>
										</div>
									</div>
									<div class="w3_agileits_main_grid w3l_main_grid">
										<div class="agileits_grid">
											<div class="name">
												<img src="http://localhost/Gas-Agency/images/signs/<?php echo htmlentities($row['sign']);?>" width="200" height="50px">
											</div>
											<div class="clear"></div>
										</div>
									</div>
									...
									<div class="w3_agileits_main_grid w3l_main_grid">
										<div class="agileits_grid">
											...
											<div class="name">
												<input type="text" name="cno" pattern="^\d{10}$" value="<?php echo htmlentities($row['cno']);?>" readonly>
											</div>
											<div class="clear"></div>
										</div>
									</div>
									...
									<div class="w3_agileits_main_grid w3l_main_grid">
										<div class="agileits_grid">
											<h5>Subsidy</h5>
												<select id="category2" name="subsidy" readonly>
													<option value="<?php echo htmlentities($row['subsidy']);?>"><?php echo htmlentities($row['subsidy']);?></option>
													<option>Yes</option>
													<option>No</option>
												</select>
											<div class="clear"></div>
